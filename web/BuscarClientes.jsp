<%-- 
    ...
    Created on : 09/05/2017, 15:33:40
    Author     : Jess
--%>
                        ...
                        <table id = "tab2">
                                <tr>
                                    <td>
                                      ...
                                      <form method ="POST" action="FrontControllerServlet">           
                                            <fieldset>
                                             ...
                                             <input type="hidden" name="control" value="BuscaCliente">
                                    ...
                                    <form method ="POST" action="FrontControllerServlet">           
                                        ...
                                        <input type="hidden" name="control" value="BuscaClientTodos"><br>
