<%-- 
    Document   : cliente
    Created on : 07/05/2017, 22:30:10
    Author     : Jess
--%>
                            ...
                            <tr>
                                <td>
                                        <h1>Cadastro de Paciente</h1><br><br>
                                            ...
                                            <a href = "AlterarCliente.jsp">Alterar</a><br><br>
                                         <input type="hidden" value="AddCliente" name="control">
                                         <input type="submit" class="bt" value="Salvar"> <br> 
