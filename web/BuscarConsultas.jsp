<%-- 
    Document   : BuscarConsultas
    Created on : 09/05/2017, 14:24:56
    Author     : Jess
--%>
                                       ...
                                       <form method ="POST" action="FrontControllerServlet">
                                            <fieldset>
                                                ...
                                                <legend>Ou</legend>
                                                   ...
                                                   <p>Data: <input type="text" name="data" size="90" maxlength="500"></p><br>   

                                            </fieldset><br>
                                          <input type="hidden" name="control" value="BuscaConsulta">
